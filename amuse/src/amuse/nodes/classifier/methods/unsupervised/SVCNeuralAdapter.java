...
public class SVCNeuralAdapter extends AmuseTask implements ClassifierUnsupervisedInterface {
	...
	public void setParameters(String parameterString) throws NodeException {
      ...
      // Check if all parameters are in range
        if (cacheSize < 0 || numSamplePoints < 1 || min_pts < 0 || p < 0.0 || p > 1.0 || r < -1.0) {
        ...
        try {
            ...
            exampleSet = result.get(ExampleSet.class);
         	...
         	// Edit the result so AMUSE can work with it again -----------------------------------------------------------------------------------------------------
        		...
        		AmuseLogger.write(this.getClass().getName(), Level.DEBUG, "SVC successfully edited the result to AMUSE standad");
